    ...
    <div className="App">
      <aside className="sidebar">
        <div className="brand-block">
          ...
          <div>
            <p className="brand-name">Personal Finance</p>
            <p className="brand-caption">Daily money control</p>
          </div>
        </div>
        ...
        <div className="sidebar-note">
          ...
          <p>Gunakan /pemasukan atau /pengeluaran untuk input cepat.</p>
        </div>
      </aside>
      ...
      <main className="app-shell" id="dashboard">
        <header className="app-header">
          ...
          <p>Kelola pemasukan, pengeluaran, dan transaksi terbaru dalam satu tampilan.</p>
        </header>
        ...
        <div className="dashboard-grid">
          <section className="dashboard-main" id="transactions">
            <TransactionList
